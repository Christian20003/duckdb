...
static const StaticFunctionDefinition core_functions[] = {
	...
	DUCKDB_SCALAR_FUNCTION_SET_ALIAS(ArrayFill),
	...
	DUCKDB_AGGREGATE_FUNCTION_SET(FAvgFun),
	...
	DUCKDB_AGGREGATE_FUNCTION_SET_ALIAS(FsumFun),
	...
	DUCKDB_AGGREGATE_FUNCTION_SET(KahanSumFun),
	...
	DUCKDB_AGGREGATE_FUNCTION_SET(ListSum),
	/* DUCKDB_AGGREGATE_FUNCTION_SET_ALIAS(ListSumAlias), */
	...
	DUCKDB_SCALAR_FUNCTION_SET_ALIAS(ListArithAddFunAlias),
	DUCKDB_SCALAR_FUNCTION_SET(ListArithSubFun),
	DUCKDB_SCALAR_FUNCTION_SET_ALIAS(ListArithSubFunAlias),
	DUCKDB_SCALAR_FUNCTION_SET(ListArithMulFun),
	DUCKDB_SCALAR_FUNCTION_SET_ALIAS(ListArithMulFunAlias),
	DUCKDB_SCALAR_FUNCTION_SET(ListArithMMulFun),
	DUCKDB_SCALAR_FUNCTION_SET_ALIAS(ListArithMMulFunAlias),
	DUCKDB_SCALAR_FUNCTION_SET(ListArithDivFun),
	DUCKDB_SCALAR_FUNCTION_SET_ALIAS(ListArithDivFunAlias),
	DUCKDB_SCALAR_FUNCTION_SET(ListSigmoid),
	DUCKDB_SCALAR_FUNCTION_SET(ListFill),
	...
	DUCKDB_AGGREGATE_FUNCTION_SET_ALIAS(SumkahanFun),
