...
static constexpr ExtensionFunctionEntry EXTENSION_FUNCTIONS[] = {
    ...
    {"list_fill", "core_functions", CatalogType::SCALAR_FUNCTION_ENTRY},
    ...
    {"list_mmul", "core_functions", CatalogType::SCALAR_FUNCTION_ENTRY},
    ...
    {"sig", "core_functions", CatalogType::SCALAR_FUNCTION_ENTRY},
